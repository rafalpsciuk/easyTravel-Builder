...
cp -v ./business/business.war ${ET_BB_DEPLOY_HOME}

mkdir -p ${ET_CF_DEPLOY_HOME} ${ET_CF_DEPLOY_LIB_HOME}
cp -v ./customer/customer.war                    ${ET_CF_DEPLOY_HOME}
cp -v ./customer/webapp/WEB-INF/lib/jsf-api.jar  ${ET_CF_DEPLOY_LIB_HOME}
cp -v ./customer/webapp/WEB-INF/lib/jsf-impl.jar ${ET_CF_DEPLOY_LIB_HOME}
